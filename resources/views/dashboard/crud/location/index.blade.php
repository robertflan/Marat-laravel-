    ...
    <section class="panel">
        <div class="panel-heading">
        	<div class="pull-right">
        		<a href="{{ url('/dashboard/locations/create') }}">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <div class="btn-group" aria-label="" role="group">
                                    	<!-- <a href="{{ url('/dashboard/locations/' . $item->id) }}">
	                                    	<button type="button" class="btn btn-success-outline">
				                                <i class="icmn-link" aria-hidden="true"></i>
				                                View
				                            </button>
			                            </a> -->
			                            <a href="{{ url('/dashboard/locations/' . $item->id . '/edit') }}">
				                            <button type="button" class="btn btn-primary">
				                                <i class="icmn-pencil3" aria-hidden="true"></i>
				                                Edit
				                            </button>
			                            </a>
						                <form action="{{ url('/dashboard/locations/' . $item->id) }}" class="d-inline" method="POST">

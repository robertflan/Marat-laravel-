                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <div class="btn-group" aria-label="" role="group">
                                    	<!-- <a href="{{ url('/dashboard/companies/' . $item->id) }}">
	                                    	<button type="button" class="btn btn-success-outline">
				                                <i class="icmn-link" aria-hidden="true"></i>
				                                View
				                            </button>
			                            </a> -->
			                            <a href="{{ url('/dashboard/companies/' . $item->id . '/edit') }}">
				                            <button type="button" class="btn btn-primary">
				                                <i class="icmn-pencil3" aria-hidden="true"></i>
				                                Edit
				                            </button>
			                            </a>
						                <form action="{{ url('/dashboard/companies/' . $item->id) }}" class="d-inline" method="POST">

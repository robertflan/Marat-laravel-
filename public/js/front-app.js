...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vee_validate_dist_locale_de__ = __webpack_require__(135);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_vee_validate__ = __webpack_require__(136);
window.Vue = __webpack_require__(130);




__WEBPACK_IMPORTED_MODULE_2_vee_validate__["a" /* Validator */].addLocale(__WEBPACK_IMPORTED_MODULE_1_vee_validate_dist_locale_de___default.a);
__WEBPACK_IMPORTED_MODULE_2_vee_validate__["a" /* Validator */].installDateTimeValidators(__WEBPACK_IMPORTED_MODULE_0_moment___default.a);
...
Vue.use(__WEBPACK_IMPORTED_MODULE_2_vee_validate__["b" /* default */], config);
...
Vue.component('execute', __webpack_require__(156));
...
var app = new Vue({
    ...
    methods: {
        ...
        validateApplication: function validateApplication() {
            var self = this;
        ...
        submitApplication: function submitApplication(param) {
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-5f25d4e8", Component.options)
  } else {
    hotAPI.reload("data-v-5f25d4e8", Component.options)
' + '  }
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-5f25d4e8", module.exports)
  }
}
